# Clase Autor: representa a un autor literario con datos personales y académicos
class Autor:
    ...
    # Muestra los datos completos del autor
    ...
    # Permite editar los datos del autor
...
# Creamos autores con datos completos
...
# Editamos los datos de un autor
autor1.editar_autor(formacion="Filosofía y Letras - Universidad de la República")
print("\nAutor actualizado:")
